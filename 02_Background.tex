...
\begin{equation}\tag{5}
    ...
    \end{aligned}
\end{equation}
where \( v_i \) are vectors constrained to the \( n \)-dimensional unit sphere. The algorithm then proceeds as follows:
\begin{enumerate}
