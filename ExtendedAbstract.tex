...
\title{\bfseries Development of a new variational quantum algorithm for MaxCut: QAOA and QEMC hybrid algorithm}
\date{June 2024}
...
\end{@twocolumnfalse}
	...
	\input{02_Background}
	\input{03_iQAQE_Framework}
	\input{04_Implementation}
	\input{05_iQAQE_Schemes&Results}
	\input{06_AlternativeSchemes}
